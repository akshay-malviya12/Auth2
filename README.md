...
# For Login 
curl -X POST http://localhost:8080/login -H "Content-Type: application/json" -d "{\"email\":\"auth@example.com\",\"password\":\"123456\"}"                                                       {"message":"Login successful","token":" ","refreshToken":""}                                                                                                                                                                             # For Refresh_Token                                 
